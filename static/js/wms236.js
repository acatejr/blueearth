...
BeiCustomGetTileUrl=function(a,b,c)
{
   
   GLog.write(this);
   return 'images/blank_test.png';
   /*
   ...
   GLog.write(lUL.x + ", " + minx);
   // filter out any tile requests outside of our bounds
	if (lUL.x < minx || lLR.x > maxx || lUL.y < miny || lLR.y > maxy)
	{
	   GLog.write("here");
	   return 'images/blank_tile.png';
   }
